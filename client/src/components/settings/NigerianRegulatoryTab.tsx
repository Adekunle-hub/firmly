  ...
  return (
    <div className="space-y-4 md:space-y-6 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {["Magistrate Court", "High Court", "Federal High Court", "Court of Appeal", "Supreme Court"].map((court) => (
            <div key={court} className="flex items-center justify-between p-3 border border-slate-100 rounded-xl bg-slate-50/30">
              <span className="text-xs font-bold text-slate-700">{court}</span>
      ...
      <div className="bg-white border border-slate-100 rounded-2xl p-4 md:p-6 space-y-2 sm:space-y-4 shadow-xs">
        ...
        <div className=" p-3 md:p-3.5 bg-emerald-50/60 text-emerald-900 rounded-xl border border-emerald-100 flex items-start md:items-center gap-2 flex-col md:flex-row justify-between text-xs font-bold shadow-xs">
      ...
      <div className="bg-white border border-slate-100 rounded-2xl p-4 md:p-6 space-y-2 sm:space-y-4 shadow-xs">
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-3">
            <Input type="number" defaultValue="5000000" className="h-11 border-slate-200 text-xs font-mono rounded-xl max-w-sm" />
            <span className="text-xs font-bold text-emerald-800 bg-emerald-50 px-3 py-1.5 rounded-xl">₦5,000,000.00</span>
          </div>
